...
bash.runCommand "${pname}-${version}-pass1"
  {
    ...
    meta = {
      description = "Python 3.1.5 first pass rebuilt with Python 2.5.6";
  ...
  ''
    ...
    ${gnupatch}/bin/patch -Np1 -i ${./3.1.5/files/py2.patch}
    ...
    ${gnumake}/bin/make -j "$NIX_BUILD_CORES" CFLAGS="-U__DATE__ -U__TIME__ -I${libffi}/include -I${zlib}/include"
