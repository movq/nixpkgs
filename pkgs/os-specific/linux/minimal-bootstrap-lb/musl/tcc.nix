...
bash.runCommand "${pname}-${version}"
  {
    ...
    meta = {
      description = "Musl libc 1.1.24 built with TinyCC";
  ...
  ''
    ...
    ${gnupatch}/bin/patch -Np1 -i ${./disable_ctype_headers.patch}
    ...
    # Disable units that require generated sources/headers
